...
export const CreateChanceSection = (props: IProps) => {
  const {
    publicId,
    products,
    data,
            ...
            <div className="info-section">
              ...
              <div className="right__content">
                ...
                <ShareInput
                  ...
                  sufIcon={
                    <Tooltip title="Chọn từ danh sách">
                      <SelectInfo onClick={() => setShowCampaigns(true)}>
                        <CampaignMenuIcon size={18} color={APP_COLORS.primary} />
                      </SelectInfo>
                    </Tooltip>
                  }
                />
