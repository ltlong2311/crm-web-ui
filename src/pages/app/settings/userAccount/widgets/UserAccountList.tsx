...
export const UserAccountList = (props: IProps) => {
  const {
    selectedId,
    showCreateModal,
    showUpdateModal,
  ...
  const columns: ColumnsType<IUserAccount[]> = [
    ...
    },
    {
      ...
      align: 'left',
      render: (value) => {
        return <TableText className="banner-desc">{value?.role}</TableText>;
      },
    },
    {
      title: 'Trạng thái',
        ...
        return (
          <div className="flex items-center justify-end">
            ...
            <PopoverPopup
              ...
              content={
                <StyledConfirmPopup>
                  <h5 className="text-center items-center mb-2 text-current text-base">Nhắc nhở</h5>
                  <p className="text-sm">Chắc chắn xóa người dùng này?</p>
                </StyledConfirmPopup>
              }
              isHaveConfirmButton
              onConfirm={() => {
