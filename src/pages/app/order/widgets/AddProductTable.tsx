...
export const AddProductTable: React.FC<IProps> = (props) => {
  ...
  const columns: any = [
          ...
          <TableText>
            <ShareInput
              ...
              onChange={debounce((e: any) => {
                ...
                dispatch(setSelectedProducts(productList));
              }, 500)}
            />
          </TableText>
        );
    ...
    },
    {
      ...
      align: 'center',
      render: (value: any) => {
        return <TableText>{formatAppUnit(value?.cost * value?.quantity, DOT)}</TableText>;
      },
    },
    {
      title: 'Chức năng',
          ...
          <CenterBox>
            <SharedButton
              ...
              onClick={() => {
                ...
                dispatch(setSelectedProducts(newOrderProducts));
              }}
            >
