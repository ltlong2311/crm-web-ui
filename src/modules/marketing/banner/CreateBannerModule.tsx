...
import { BannerFormSchema, ProductFormSchema } from '@validations';
import { useEffect, useState } from 'react';
import { BannerFormModal, CategoryFormModal, ProductFormModal } from '@pages';
...
export const CreateBannerModule = (props: IProps) => {
